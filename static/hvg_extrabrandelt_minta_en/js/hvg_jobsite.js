...
$(document).ready(function (){
	...
	if(!isMobile && $(window).width()>800){
		$('.video-holder').append('<video class="hero-video"  id="bgvid" playsinline autoplay muted loop><source src="https://static.hvgrt.hu/static/hvg_covers/video.mp4" type="video/mp4"></video>');
    ...
    $('body').scrollspy({ target: '#site-nav li:not(:last-child)' });
  ...
  var coversArray = [
	...
	function createCovers(id){
		for(var i=1979;i<2019;i++){
			...
			imagesHtmlContent += `<a href="#" class='swiper-slide'><img src="https://static.hvgrt.hu/static/hvg_covers/${i}.jpg" alt="" /><div class="description"><span>${i}</span></div></a>`;
		}		
